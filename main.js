  ...
  var prodEl, prodTitleEl, prodImgEl, prodDetEl, prodPriceEl, toCartBtnEl, catWrapperEl;
    ...
    for (var i = 0;  i < products.length; i++) {
        ...
        // product image
            ...
            prodImgEl.addEventListener('click', handleProdImageClick); //EVENT LISTENER
...
//QUESTION PART 1/2!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// this listener attachment works just fine! as well as line marked with //EVENT LISTENER above
